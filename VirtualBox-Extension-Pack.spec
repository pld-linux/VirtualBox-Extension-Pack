...
Source0:	http://download.virtualbox.org/virtualbox/%{version}_%{pre}/Oracle_VM_VirtualBox_Extension_Pack-%{version}_%{pre}-%{prev}.vbox-extpack
# NoSource0-md5:	32ae7f102d00ad9f165741db72ecec95
NoSource:	0
